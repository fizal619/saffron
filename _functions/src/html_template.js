module.exports = (body, order = false) => `
<!doctype html>
...
@import url(https://fonts.googleapis.com/css?family=Cabin:400,700);
    ...
    @media only screen and (max-width:480px) {
      ...
      <img height="auto" src="https://s3-eu-west-1.amazonaws.com/topolio/uploads/5faadab2e31cd/1605067221.jpg" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600">
      ...
      ${order && '<table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">\
      <tbody>\
        <tr>\
          <td style="width:600px;">\
              <img height="auto" src="https://s3-eu-west-1.amazonaws.com/topolio/uploads/5faadab2e31cd/1605067652.jpg" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600">\
          </td>\
        </tr>\
        </tbody>\
      </table>\
      ...
      <!--[if mso | IE]>
        <table
           align="center" border="0" cellpadding="0" cellspacing="0" style="border-top:solid 3px #000000;font-size:1;margin:0px auto;width:565px;" role="presentation" width="565px"
        >
          <tr>
            ...
            <tr>
              ...
              ${order && '<table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">\
                <tbody>\
                  <tr>\
                    <td style="width:600px;">\
                <img height="auto" src="https://s3-eu-west-1.amazonaws.com/topolio/uploads/5faadab2e31cd/1605068400.jpg" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600">\
                      </td>\
                    </tr>\
                  </tbody>\
                </table>'
          ...
          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:transparent;border-radius:3px;width:35px;">
            <tr>
              <td style="font-size:0;height:35px;vertical-align:middle;width:35px;">
                <a href="https://www.facebook.com/saffroncateringgy" target="_blank">
      ...
      <tr>
        <td style="padding:4px;">
          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:transparent;border-radius:3px;width:35px;">
            <tr>
              <td style="font-size:0;height:35px;vertical-align:middle;width:35px;">
                <a href="https://www.instagram.com/saffroncateringgy" target="_blank">
